...
class OSGiXMLChangeLogSAXHandler extends DefaultHandler {
    ...
    protected OSGiXMLChangeLogSAXHandler(String physicalChangeLogLocation,
	...
	protected boolean handleIncludedChangeLog(String fileName, boolean isRelativePath, String relativeBaseFileName)
      ...
      try {
         changeLog= changeLogParserFactory.getParser(fileName, resourceAccessorToUse).parse(fileName, changeLogParameters,
